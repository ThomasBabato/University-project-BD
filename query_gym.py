...
import app
from app import *
from sqlalchemy import update, func, insert, delete, values, or_, select, and_, text
...
def change_role(utente,Id_utente,mail,new_role):
    Session = sessionmaker(bind=engine)
    session = Session()
